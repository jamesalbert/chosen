...
(function() {
  ...
  Chosen = (function(_super) {
    ...
    Chosen.prototype.register_observers = function() {
      ...
      this.search_groups.bind('mouseup.chosen', function(evt) {
        _this.search_results_mouseup(evt);
      });
      this.search_groups.bind('mouseover.chosen', function(evt) {
        _this.search_results_mouseover(evt);
      });
      this.search_groups.bind('mouseout.chosen', function(evt) {
        _this.search_results_mouseout(evt);
      });
      this.search_groups.bind('mousewheel.chosen DOMMouseScroll.chosen', function(evt) {
    ...
    Chosen.prototype.result_select = function(evt) {
      ...
      if ($(evt.target).hasClass("group-result")) {
        ...
        $(evt.target).nextAll().each(function(_, option) {
          var array_index, is_chosen;
          if (!$(option).hasClass("group-result")) {
            array_index = $(option).attr("data-option-array-index");
            is_chosen = false;
            $('#pops_chosen > .chosen-choices').find('.search-choice-close').each(function(_, choice) {
